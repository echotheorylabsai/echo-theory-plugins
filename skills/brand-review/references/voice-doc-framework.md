...
Use this reference when the user wants to **author or revise** their brand voice document (`brand/voice.md`). This file is consulted only in that branch of the `brand-review` workflow — do not load it during content reviews.
