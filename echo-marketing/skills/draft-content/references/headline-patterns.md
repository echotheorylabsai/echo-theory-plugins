...
- **Cited statistic** — "Over 40% of agentic AI projects will be cancelled by 2027 ([Publisher, Month YYYY](url)). The failure pattern is consistent..." (always use a real, recent citation — no older than 90 days from today)
